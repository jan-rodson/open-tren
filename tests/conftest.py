...
def gtfs_static_files(tmp_path: Path) -> Path:
    ...
    (gtfs_dir / "stops.txt").write_text(
        ...
        "17000,Madrid Atocha,40.398,-3.693\n"
        "08001,Barcelona Sants,41.379,2.140\n"
        "50012,Zaragoza Delicias,41.639,-0.900\n"
    )
    ...
    (gtfs_dir / "stop_times.txt").write_text(
        ...
        "T0019012026-02-19,17000,1,08:00:00,08:00:00\n"
        "T0019012026-02-19,08001,2,10:30:00,10:35:00\n"
        "T0019012026-02-19,50012,3,12:00:00,12:00:00\n"
        "T56012026-02-19,17000,1,14:00:00,14:00:00\n"
        "T56012026-02-19,50012,2,16:30:00,16:35:00\n"
        "T56012026-02-19,08001,3,18:00:00,18:00:00\n"
        "T0019022026-02-19,17000,1,20:00:00,20:00:00\n"
        "T0019022026-02-19,08001,2,22:30:00,22:35:00\n"
        "T0019022026-02-19,50012,3,00:00:00,00:00:00\n"
    )
